...
Це shallow navigation index, а не обов'язковий контекст. Відкривайте лише документи, потрібні для конкретного завдання.
...
- Завершені Epics 1–5, 2b і 3b: [plans/archive](plans/archive/)
- Superseded Epics 8–9: [plans/archive/superseded](plans/archive/superseded/)
- Historical QA evidence and design review: [qa/archive](qa/archive/)
