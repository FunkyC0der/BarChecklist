import { ISO_WEEKDAYS, type TaskFormValues } from './checklist-schema';

export function cadenceLabel(cadence: TaskFormValues['cadence']) {
  return cadence === 'daily' ? 'Щодня' : 'Щотижня';
}

export function formatTaskSchedule(values: {
  cadence: TaskFormValues['cadence'];
